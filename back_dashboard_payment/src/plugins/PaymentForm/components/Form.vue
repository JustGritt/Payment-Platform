...
<template>
    <FormKit type="form" class="form-payment-container" outer-class="i-will-be-appended" v-model="values">
        ...
        <section>
            ...
            <div>
                <FormKit :type="inputCard" :class="font - size20" name="type_payment" label="Best movie" :options="[
